...
\begin{document}
	...
	% Parei no seguinte parágrafo:
	% A Região Metropolitana de Curitiba abarca os três maiores PIBs do estado, sendo que correspondem também aos únicos municípios do estado a aparecerem no top 50 PIBs do país.
	% Talvez seja interessante reescrever mais uma vez.
